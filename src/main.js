...
import product_data from './product.js';/*暂时没有服务器数据,仿造自己的数据*/
...
const store = new Vuex.Store({
    ...
    actions: {
        ...
        getProductList (context) {
			...
			var style = divlist.style;
			style.display = "flex";
			style.alignItems = "center";
			style.justifyContent = "center";
			divlist.style.color = "black";
			divlist.style.width = "100px";
			divlist.style.height = "100px";
			divlist.style.borderRadius = "100%";
			divlist.style.background = "#18B566";
